#!/usr/bin/env python3
"""
Test the fixed Window of Viability plot with constrained_layout
"""
...
# Create figure with constrained_layout to prevent cropping
...
# NO plt.tight_layout() - using constrained_layout instead
# Save without bbox_inches to prevent cropping
plt.savefig('window_of_viability_plot_fixed.png', dpi=300)  # No bbox_inches
plt.savefig('window_of_viability_plot_fixed.pdf')  # No bbox_inches
print("✓ Plot saved as: window_of_viability_plot_fixed.png (300 DPI) and .pdf")
print("  Using constrained_layout=True and no bbox_inches to prevent cropping")
